...
async function initialize() {
  ...
  if ("serviceWorker" in navigator) {
    navigator.serviceWorker.register("./service-worker.js?v=20260410b").catch(() => {
...
function normalizeState(raw = {}) {
  ...
  return {
    ...DEFAULT_STATE,
    ...raw,
    activeRealm: allowedRealms.has(raw.activeRealm) ? raw.activeRealm : DEFAULT_STATE.activeRealm,
