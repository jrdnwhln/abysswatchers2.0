...
- a tabbed Caveman Bot that riffs on questions, remembers a local name/email, and prepares a caveman portrait email in the user's mail app
...
- the Caveman Bot transcript plus the local name/email fields are stored locally
...
- the Caveman Bot is intentionally comedic, and the "email send" flow prepares a `mailto:` draft instead of silently sending real email from the browser
